    ...
    <main className="min-h-screen px-4 py-12">
      <div className="mx-auto max-w-4xl px-xl py-2xl">
        ...
        <div className="mt-8 space-y-6 text-sm leading-6 text-chrome-body">
          <section>
            <h2 className="text-base font-semibold text-chrome-title">Acceptance of terms</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-chrome-title">User responsibilities</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-chrome-title">Moderation and account actions</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-chrome-title">Service availability</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-chrome-title">Changes to terms</h2>
            <p className="mt-2">
