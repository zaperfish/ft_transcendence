...
import type { EventEntity, CreateEventRequest } from '@/types/event';
...
export default function EditEventModal({
	...
	const updateMutation = useMutation({
		mutationFn: (data: Partial<CreateEventRequest>) => updateEvent(event.id, data),
		onSuccess,
	});
						...
						<div className='space-y-sm'>
							...
							<input
								...
								{...register("max_capacity", {
									...
									min: {
										value: event.num_registered,
										message: `Max capacity should be no less than number of registered (${event.num_registered})`,
									},
									max: {
										value: 10000,
